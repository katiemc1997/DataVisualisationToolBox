...
public class tiny_gp {
	...
	static final int MAX_LEN = 10000, POPSIZE = 10000, DEPTH = 5, GENERATIONS = 60, TSIZE = 2, RUNS = 20;
	...
	static void setup_fitness(String Tiny) {
		try {
			int i, j;
			String line;

			FileReader fr = new FileReader("/Users/mac/Pictures/FYP/problem.dat");
	...
	void stats(double[] fitness, char[][] pop, int gen, int run) {
	...
	static void print_parms() {
		System.out.print("Run,Generation,PopSize,Nodes,AvgFitness,BestFitness,AvgSize\n");
	}
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		try {
			...
			PrintWriter the_output2 = new PrintWriter(new FileWriter(the_file, true));
			the_output2.print("Run,Generation,PopSize,Nodes,AvgFitness,BestFitness,AvgSize\n");
			the_output2.close();
		} catch (IOException e) {
